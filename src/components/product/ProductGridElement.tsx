...
function ProductGridElement({
  ...
  if (product) {
    return (
      <div
        className={cn(
          "flex w-full flex-col items-center gap-3 rounded-lg border-2 border-primary-bg-3 bg-primary-bg-2 p-3 shadow-md",
          className,
        )}
      >
        <div className="col-span-3 flex aspect-square w-full items-center justify-center bg-primary-bg-2 bg-white">
